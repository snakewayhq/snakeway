  ...
  pub mod snakeway {
    pub mod device {
      ...
      pub mod policy {
        ...
        /// Request body chunk of bytes with a flag indicating the stream has ended.
        #[derive(Clone)]
        ...
        /// For every chunk of the request body processed, a decision is returned.
        #[repr(C)]
        #[derive(Clone, Copy)]
        ...
        impl ::core::fmt::Debug for BodyResult {
          fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_struct("BodyResult").field("decision", &self.decision).finish()
          }
        }
      ...
      #[doc(hidden)]
      #[allow(non_snake_case, unused_unsafe)]
      pub unsafe fn _export_on_stream_request_body_cabi<T: Guest>(arg0: *mut u8,arg1: usize,arg2: *mut u8,arg3: usize,arg4: *mut u8,arg5: usize,arg6: i32,arg7: *mut u8,arg8: usize,arg9: i32,) -> i32 { unsafe {#[cfg(target_arch="wasm32")]
      _rt::run_ctors_once();let result10 = {
        ...
        _rt::cabi_dealloc(base8, len8 * (4*::core::mem::size_of::<*const u8>()), ::core::mem::size_of::<*const u8>());
        T::on_stream_request_body(Request{
          original_path: _rt::string_lift(bytes0),
          route_path: _rt::string_lift(bytes1),
          headers: result8,
        }, match arg6 {
          ...
          1 => {
            let e = {
              ...
              BodyChunk{
                data: <_ as From<_rt::Vec<_>>>::from(_rt::Vec::from_raw_parts(arg7.cast(), len9, len9)),
                end_of_stream: _rt::bool_lift(arg9 as u8),
              }
            };
            Some(e)
          }
      ...
      let BodyResult{ decision:decision11, } = result10;
      decision11.clone() as i32
    } }
    #[doc(hidden)]
    #[allow(non_snake_case, unused_unsafe)]
...
pub trait Guest {
  ...
  /// Called (potentially multiple times) as the request body is read
  #[allow(async_fn_in_trait)]
...
et-route-path\x0a\x11set-upstream-path\x0a\x0bset-headers\x02\x0eremove-headers\x0b\
\x04\0\x0drequest-patch\x03\0\x0c\x01k{\x01r\x03\x0aset-status\x0e\x0bset-header\
s\x02\x0eremove-headers\x0b\x04\0\x0eresponse-patch\x03\0\x0f\x01m\x02\x08contin\
ue\x05block\x04\0\x08decision\x03\0\x11\x01r\x01\x08decision\x12\x04\0\x0bbody-r\
esult\x03\0\x13\x01k\x0d\x01r\x02\x08decision\x12\x05patch\x15\x04\0\x0erequest-\
result\x03\0\x16\x01k\x10\x01r\x02\x08decision\x12\x05patch\x18\x04\0\x0frespons\
