...
//     // Act
//     let res =
//         reqwest::blocking::get("http://127.0.0.1:4041/index.html").expect("static request failed");
//
...
//     // common::wait_for_server("127.0.0.1:4000", std::time::Duration::from_secs(2));
//     common::start_server(&SERVER, CONFIG);
//     // common::wait_for_server("127.0.0.1:4041", std::time::Duration::from_secs(2));
//
//     // Act
