...
pub const RATE_LIMITER_FILTER_REACTION_INTERVAL_IN_SECONDS: RangeConstraint<u16> =
    RangeConstraint {
        min: 1,
        max: 60,
...
pub const RATE_LIMITER_FILTER_MAX_CONNECTIONS_PER_SECOND: RangeConstraint<u16> = RangeConstraint {
    min: 1,
    max: 30_000,
