...
The renewed certificate is stored via the configured `CertStore` implementation and immediately made available
to new TLS handshakes — without requiring a server restart or reload.
