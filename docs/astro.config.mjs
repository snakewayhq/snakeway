        ...
        starlight({
            ...
            sidebar: [
                ...
                },
                {
                    label: 'Internals',
                    items: [
                        {label: 'Request Pipeline', link: '/internals/request-pipeline/'},
                        {label: 'Threading Model', link: '/internals/threading-model/'},
                        {label: 'Safety and Sandboxing', link: '/internals/safety-and-sandboxing/'},
                        {label: 'Design Decisions', link: '/internals/design-decisions/'},
                    ],
                },
                {
                    label: 'Roadmap',
