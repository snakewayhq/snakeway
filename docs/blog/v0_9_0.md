...
See the [Ingress configuration reference](/docs/configuration/ingress/#routes) for full details.
...
See [endpoint.tls](/docs/configuration/ingress/#endpointtls) for the full field reference.
