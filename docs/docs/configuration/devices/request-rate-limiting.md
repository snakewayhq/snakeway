...
:::tip
Rate limits automatically recover once a client's traffic subsides.
There is no manual reset required, and no penalty period beyond the window duration itself.
:::
